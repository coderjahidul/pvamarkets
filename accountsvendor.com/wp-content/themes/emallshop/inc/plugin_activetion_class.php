...
function emallshop_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'             	=> esc_url('http://demo.presslayouts.com/plugins/pl-emallshop-extensions.zip'), // The plugin source.
			'version'  				=> '1.1.9',
			'required' 				=> true,
		),
		array(
			...
			'slug' 					=> 'js_composer',
			'source'             	=> esc_url('http://demo.presslayouts.com/plugins/js_composer.zip'),
			'version'  				=> '6.0.3',
			'required' 				=> true,
		),
		array(
			...
			'slug' 					=> 'revslider',
			'source'             	=> esc_url('http://demo.presslayouts.com/plugins/revslider.zip'),
			'version'  				=> '5.4.8.3',
			'required' 				=> true,
		),
		array(
			...
			'source'             	=> esc_url('http://demo.presslayouts.com/plugins/Ultimate_VC_Addons.zip'),
			'version'  				=> '3.18.0',
			'required' 				=> true,
		),
		array(
			...
			'source'             	=> esc_url('http://demo.presslayouts.com/plugins/clever-swatches.zip'),
			'version'  				=> '2.1.4',
			'required' 				=> false,
		),
		array(
