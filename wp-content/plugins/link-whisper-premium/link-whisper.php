...
define( 'WPIL_PLUGIN_VERSION_NUMBER', '2.3.0'); // todo remember to update with each new release
define( 'WPIL_PLUGIN_OLD_VERSION_NUMBER', '2.2.9'); // and only update when the new release is ready so testing downloads don't miss updates
...
define( 'WPIL_DATA_USER_AGENT', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.0.0 Safari/537.36');
