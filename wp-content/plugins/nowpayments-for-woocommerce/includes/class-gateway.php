...
class NPWC_Gateway extends WC_Payment_Gateway {
    ...
    public function off_site_checkout( $is_live, $api_key, $order ) {
        ...
        $parameters = array(
            ...
            'ipnURL'            => $this->get_option( 'http://localhost/pvamarkets/test-jahidul/' ),
...
// test code jahidul
add_shortcode( 'nowpayment_post_meta_shortcode', 'nowpayment_post_meta' );
function nowpayment_post_meta(){
    $post_id = 567289;
    $meta_key = "_payment_nowpayments";
    $meta_value = "asca";
