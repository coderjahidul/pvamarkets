...
if ( ! function_exists( 'accountsseller_emallshop_customer_support' ) ):

	function accountsseller_emallshop_customer_support(){?>
		...
		<?php if(emallshop_get_option('show-topbar-email', 1) ==1 || emallshop_get_option('show-topbar-number', 1) ==1):?>
			...
			<div class="customer-support">
				...
				<div class="customer-support-telegram"><a target="_blank" href="https://t.me/accountsseller360"><i class="fa fa-telegram"></i><span>@accountsseller360</span></a></div>
