...
namespace {
    ...
    class InstallerBootstrapData {
        const ARCHIVE_FILENAME       = '20231120_accountsseller_fe69cef881a87db24424_20231120083916_archive.zip';
        const ARCHIVE_SIZE           = '736930374';
        const INSTALLER_DIR_NAME     = 'dup-installer';
        const PACKAGE_HASH           = 'fe69cef-20083916';
        const SECONDARY_PACKAGE_HASH = 'a4dfca9-20083916';
